...
public:
    ...
    void OnLazyAttach() override {
        ...
        PushLayer(hudLayer);
        PushLayer(modelLayer);

        AddLight(new AmbientLight(glm::vec4(1.0, 1.0, 1.0, 0.1)));
        AddLight(new PointLight(glm::vec4(1.0f), glm::vec3(-1.5, 0.0, 0.0)));
        AddLight(new PointLight(glm::vec4(1.0f), glm::vec3(0.0, 1.0, -1.0)));
        AddLight(new PointLight(glm::vec4(1.0f), glm::vec3(1.5, 0.0, 0.0)));
        AddLight(new SpotLight(glm::vec4(1.0, 1.0, 0.0, 1.0), glm::vec3(21.0, 1.0, 0.0), glm::vec3(1.0, -0.5, 0.0), 32.f, 34.f));
        AddLight(new SpotLight(glm::vec4(1.0, 1.0, 0.0, 1.0), glm::vec3(15.0, 0.0, 0.0), glm::vec3(0.0, -0.5, 0.0), 32.f, 34.f));
    }
