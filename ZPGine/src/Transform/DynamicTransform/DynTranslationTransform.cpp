#include "DynTranslationTransform.h"
#include <glm/gtc/matrix_transform.hpp>

namespace ZPG {

DynTranslationTransform::DynTranslationTransform(
...
void DynTranslationTransform::Update(Timestep ts) {
...
void DynTranslationTransform::ComputeMatrix() {
